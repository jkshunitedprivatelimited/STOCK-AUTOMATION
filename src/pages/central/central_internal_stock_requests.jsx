...
const CentralInternalStockRequests = () => {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel("central-internal-stock-request-orders-updates")
  ...
  useEffect(() => {
    if (!profile) return;
    const channel = supabase
      .channel("central-internal-stocks-oos-updates")
    ...
    <div className="min-h-screen bg-[#F3F4F6] font-sans text-black relative pb-20">
      ...
      <header style={styles.header}>
        <div style={styles.headerInner}>
          ...
          <h1 style={styles.heading}>INTERNAL <span style={{ color: BRAND_GREEN }}>STOCK REQUEST</span></h1>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", flexShrink: 0 }}>
            <div style={styles.idBox}>ID : CENTRAL</div>
            {activeTab === "browse" && (
...
export default CentralInternalStockRequests;